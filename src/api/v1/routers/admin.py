...
def _offre_dto_vers_response(offre_dto) -> OffreResponse:
    ...
    return OffreResponse(
        ...
        eligibilite_activee=offre_dto.eligibilite_activee,
        niveau_academique_minimum=offre_dto.niveau_academique_minimum,
        langues_requises=offre_dto.langues_requises,
        disponibilite_requise=offre_dto.disponibilite_requise,
